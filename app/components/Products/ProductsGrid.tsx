...
const data = [
  {
    title: "ASE 50",
    desc: "ASE 50 : Performance et design innovants.",
    src: Img1,
    content: <ProductDetails product={products[0]} />,
  },
  {
    title: "ASE 60",
    desc: "ASE 60 : Un saut en avant pour vos projets architecturaux.",
    src: Img2,
    content: <ProductDetails product={products[1]} />,
  },
  {
    title: "AWS 60",
    desc: "AWS 60 : L'alliance parfaite entre esthétique et efficacité énergétique.",
    src: Img3,
    content: <ProductDetails product={products[2]} />,
  },
  {
    title: "AWS 60 BD",
    desc: "AWS 60 BD : Des fenêtres de haute performance, sécurisées et esthétiques.",
    src: Img4,
    content: <ProductDetails product={products[3]} />,
  },
  {
    title: "AWS 75",
    desc: "AWS 75 : Une solution de menuiserie alliant isolation thermique et design moderne.",
    src: Img5,
    content: <ProductDetails product={products[4]} />,
  },
  {
    title: "AWS 75 BD",
    desc: "AWS 75 BD : Fenêtres haut de gamme avec sécurité renforcée et performances thermiques exceptionnelles.",
    src: Img6,
    content: <ProductDetails product={products[5]} />,
  },
  {
    title: "AWS 90",
    desc: "AWS 90 : Excellence en isolation thermique et acoustique pour vos projets d'envergure.",
    src: Img7,
    content: <ProductDetails product={products[6]} />,
  },
  {
    title: "AWS 90 BD",
    desc: "AWS 90 BD : Haute performance et sécurité avancée pour une menuiserie durable et esthétique.",
    src: Img8,
